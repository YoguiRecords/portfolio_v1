...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: "/experiences", label: "Expériences", icon: "path", group: "Contenu" },
  { href: "/formations", label: "Formations", icon: "article", group: "Contenu" },
  { href: "/langues", label: "Langues", icon: "message", group: "Contenu" },
  { href: "/interets", label: "Intérêts", icon: "skills", group: "Contenu" },
