...
const requests: RdvRow[] = [
  { id: "1", name: "Alice", email: "a@x.test", topic: "Démo", message: null, status: "PENDING", requestedAtLabel: "01/07 10:00" },
  { id: "2", name: "Bob", email: "b@x.test", topic: null, message: null, status: "CONFIRMED", requestedAtLabel: null },
];

function makeActions() {
  return { confirm: vi.fn(), decline: vi.fn() };
}
